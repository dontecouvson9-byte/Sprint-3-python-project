...
# Task 3c
# A tuple is more appropriate than a list here because this metadata never changes.
# Tuples are immutable, which protects the data from accidental modification.
